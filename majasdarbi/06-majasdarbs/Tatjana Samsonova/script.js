...
const characters = ["a", "b", "c", "d", "f", "g", "h", "s", "k", "l"];
...
/* 7) japievino event listener keyPress un parbaudit ievadito to tastaturas vertibu ar izveleto vertibu pirms tam
...
ocument.addEventListener ('keypress', (eventobject) => {
